...
class BCH63_51_Decoder:
    ...
    def hard_decode(self, r: List[int]):
        ...
        print(f"error locator poly: sigma1={bits_to_hex_string(sigma1)}, sigma2={bits_to_hex_string(sigma2)}, degree={sigma_length}")
    ...
    def soft_decode(self, r: List[float], p: int = 2):
        ...
        for pattern in patterns:
            ...
            print(f"is decode success: {success}")
            if not success:
            ...
            print(f"all roots: {sorted(set_roots ^ set_extra)}")
...
if __name__ == "__main__":
    ...
    bits = """"""
    ...
    _,soft_result, all_falied = dec.soft_decode(llrs, p=2)
