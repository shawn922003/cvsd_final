...
class BCH255_239_Decoder:
    ...
    def hard_decode(self, r: List[int]):
        ...
        print(f"Syndromes: S1={bits_to_hex_string(S1)}, S2={bits_to_hex_string(self.gf.square_table(S1))}, S3={bits_to_hex_string(S3)}, S4={bits_to_hex_string(self.gf.square_table(self.gf.square_table(S1)))}")
        sigma1, sigma2, sigma_length = self.berlekamp(S1, S3)
        print(f"Error Locator Polynomial: σ1={bits_to_hex_string(sigma1)}, σ2={bits_to_hex_string(sigma2)}")
        roots = self.chien_search(sigma1, sigma2)
        print(f"Chien Search Roots: {roots}")
    ...
    def soft_decode(self, r: List[float], p: int = 2):
        ...
        for pattern in patterns:
            ...
            print(f"current best roots: {best_roots}")
...
if __name__ == "__main__":
    ...
    bits = """"""
