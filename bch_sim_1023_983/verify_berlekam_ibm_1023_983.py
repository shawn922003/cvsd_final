...
from bch_berlekamp_decode import BCH1023_983_Decoder as BerlekampDecoder
from bch_ibm_decode import BCH1023_983_Decoder as IBMDecoder
...
def run_trials(num_trials=10000, max_errors=4, seed=0):
    ...
    # 檢查一下參數
    assert N == 1023 and T == 4, "目前腳本是針對 BCH(255,239), t=2 寫的。"
...
if __name__ == "__main__":
    ...
    run_trials(num_trials=10000, max_errors=6, seed=0)
