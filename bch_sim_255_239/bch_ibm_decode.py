...
class BCH255_239_Decoder:
    ...
    def soft_decode(self, r: List[float], p: int = 2):
        ...
        for pattern in patterns:
            ...
            root_abs_llr = 0
            for idx in roots:
                root_abs_llr += abs(r[idx])
            print(f"pattern={pattern}, roots={roots}, sum|LLR_roots|={root_abs_llr}, success={success}")
...
if __name__ == "__main__":
    ...
    bits = """"""
