...
from bch_berlekamp_decode import BCH255_239_Decoder as BerlekampDecoder
from bch_ibm_decode import BCH255_239_Decoder as IBMDecoder
...
def run_trials(num_trials=10000, max_errors=4, seed=0):
    ...
    # 檢查一下參數
    assert N == 255 and T == 2, "目前腳本是針對 BCH(255,239), t=2 寫的。"
