...
def main():
    ...
    if args.mode=="hard":
        data_path = os.path.join(args.outdir, "p100.txt")
        ans_path  = os.path.join(args.outdir, "p100a.txt")
    else:
        data_path = os.path.join(args.outdir, "soft_decoder_100.txt")
        ans_path  = os.path.join(args.outdir, "soft_decoder_100a.txt")
